...
const Terms = () => (
  <div className="min-h-screen bg-background">
    ...
    <div className="container mx-auto px-4 pt-24 pb-16 max-w-3xl">
      ...
      <h1 className="text-3xl font-bold text-foreground mb-6">Общи условия</h1>
      <div className="prose prose-sm text-muted-foreground space-y-4">
        <p>Тази страница е в процес на изготвяне. Общите условия за ползване на SmartBite SZ ще бъдат публикувани тук скоро.</p>
